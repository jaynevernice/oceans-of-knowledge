...
<head>
    ...
    <title>Faculty | Vaccination Form</title>
...
<body>
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-links">
                    ...
                    <!-- Vaccination Form -->
                    <li class="nav-links">
                        <a href="facultyVaccinationForm.php"  class="active">
    ...
    <section class="home">
        <div class="text">Faculty Vaccination Form</div>
            ...
            <form class="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <input name="surname" type="text" class="form-control" value="<?php echo $faculty['surname']; ?>" disabled>
                    </div>
                    <div class="col-md-4 mb-4">
                        <input name="givenName" type="text" class="form-control" value="<?php echo $faculty['givenName']; ?>" disabled>
                    </div>
                    <div class="col-md-2 mb-4">
                        <input name="mi" type="text" class="form-control" value="<?php echo $faculty['mi']?>" disabled>
                    </div>
                    <div class="col-md-2 mb-4">
                        <input name="suffix" type="text" class="form-control" value="<?php echo $faculty['suffix']?>" disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        <input name="address" type="text" class="form-control" placeholder="Address" required value="<?php echo $faculty['address']?>">
                    </div>
                    <div class="col-md-4 mb-3">
                        <input name="contact" type="text" class="form-control" placeholder="Contact No." required value="<?php echo $faculty['contact']?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <input name="dob" type="date" class="form-control" placeholder="Date of Birth" required value="<?php echo $faculty['dob']?>">
                    </div>
                    <div class="col-md-3 mb-3">
                        <select name="sex" class="form-select">
                            <option selected disabled value="">Sex</option>
                            <option value="Female" <?php if($faculty['sex']=="Female") echo 'selected="selected"'; ?> >Female</option>
                            <option value="Male" <?php if($faculty['sex']=="Male") echo 'selected="selected"'; ?> >Male</option>
                        </select>
                    </div>
                    <div class="col-md-3 mb-3">
                        <input name="philhealth" type="text" class="form-control" placeholder="PhilHealth No." value="<?php echo $faculty['philhealth']?>">
                    </div>
                    <div class="col-md-3 mb-3">
                        <select name="category" class="form-select">
                            <option selected disabled value="">Category</option>
                            <option disabled value="">-------Group A-------</option>
                            <option value="A1" <?php if($faculty['category']=="A1") echo 'selected="selected"'; ?> >A1</option>
                            <option value="A2" <?php if($faculty['category']=="A2") echo 'selected="selected"'; ?> >A2</option>
                            <option value="A3" <?php if($faculty['category']=="A3") echo 'selected="selected"'; ?> >A3</option>
                            <option value="A4" <?php if($faculty['category']=="A4") echo 'selected="selected"'; ?> >A4</option>
                            <option value="A5" <?php if($faculty['category']=="A5") echo 'selected="selected"'; ?> >A5</option>
                            <option disabled value="">-------Group B-------</option>
                            <option value="B1" <?php if($faculty['category']=="B1") echo 'selected="selected"'; ?> >B1</option>
                            <option value="B2" <?php if($faculty['category']=="B2") echo 'selected="selected"'; ?> >B2</option>
                            <option value="B3" <?php if($faculty['category']=="B3") echo 'selected="selected"'; ?> >B3</option>
                            <option value="B4" <?php if($faculty['category']=="B4") echo 'selected="selected"'; ?> >B4</option>
                            <option value="B5" <?php if($faculty['category']=="B5") echo 'selected="selected"'; ?> >B5</option>
                            <option value="B6" <?php if($faculty['category']=="B6") echo 'selected="selected"'; ?> >B6</option>
                            <option disabled>-------Group C-------</option>
                            <option value="C" <?php if($faculty['category']=="C") echo 'selected="selected"'; ?> >C</option>
                        </select>
                    </div>
                </div>
                    ...
                    <table class="table table-sm">
                        ...
                        <tr>
                            <th scope="row">First</th>
                                <td>
                                    <input class="form-control" name="firstDoseDate" type="date" value="<?php echo $faculty['firstDoseDate']?>">
                                </td>
                                <td>
                                    <select name="firstDoseBrand" class="form-select">
                                        <option selected disabled>Select</option>
                                        <option value="Pfizer" <?php if($faculty['firstDoseBrand']=="Pfizer") echo 'selected="selected"'; ?> >Pfizer</option>
                                        <option value="Moderna" <?php if($faculty['firstDoseBrand']=="Moderna") echo 'selected="selected"'; ?> >Moderna</option>
                                        <option value="Astrazeneca" <?php if($faculty['firstDoseBrand']=="Astrazeneca") echo 'selected="selected"'; ?> >Astrazeneca</option>
                                        <option value="Johnson & Johnsons Janssen" <?php if($faculty['firstDoseBrand']=="Johnson & Johnsons Janssen") echo 'selected="selected"'; ?> >Johnson & Johnsons Janssen</option>
                                    </select>
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="firstVaccinator" value="<?php echo $faculty['firstVaccinator']?>">
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="firstBatchNo" value="<?php echo $faculty['firstBatchNo']?>">
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="firstLotNo" value="<?php echo $faculty['firstLotNo']?>">
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" name="secondDoseDate" type="date" value="<?php echo $faculty['secondDoseDate']?>">
                            </td>
                            <td>
                                <select name="secondDoseBrand" class="form-select">
                                    <option selected disabled>Select</option>
                                    <option value="Pfizer" <?php if($faculty['secondDoseBrand']=="Pfizer") echo 'selected="selected"'; ?> >Pfizer</option>
                                    <option value="Moderna" <?php if($faculty['secondDoseBrand']=="Moderna") echo 'selected="selected"'; ?> >Moderna</option>
                                    <option value="Astrazeneca" <?php if($faculty['secondDoseBrand']=="Astrazeneca") echo 'selected="selected"'; ?> >Astrazeneca</option>
                                    <option value="Johnson & Johnsons Janssen" <?php if($faculty['secondDoseBrand']=="Johnson & Johnsons Janssen") echo 'selected="selected"'; ?> >Johnson & Johnsons Janssen</option>
                                </select>
                            </td>
                            <td>
                                <input class="form-control" type="text" name="secondVaccinator" value="<?php echo $faculty['secondVaccinator']?>">
                            </td>
                            <td>
                                <input class="form-control" type="text" name="secondBatchNo" value="<?php echo $faculty['secondBatchNo']?>">
                            </td>
                            <td>
                                <input  class="form-control" type="text" name="secondLotNo" value="<?php echo $faculty['secondLotNo']?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th scope="row">Booster</th>
                                <td>
                                    <input class="form-control" name="boosterDate" type="date" value="<?php echo $faculty['boosterDate']?>">
                                </td>
                                <td>
                                    <select name="boosterBrand" class="form-select">
                                        <option selected disabled value="">Select</option>
                                        <option value="Pfizer" <?php if($faculty['boosterBrand']=="Pfizer") echo 'selected="selected"'; ?> >Pfizer</option>
                                        <option value="Moderna" <?php if($faculty['boosterBrand']=="Moderna") echo 'selected="selected"'; ?> >Moderna</option>
                                        <option value="Astrazeneca" <?php if($faculty['boosterBrand']=="Astrazeneca") echo 'selected="selected"'; ?> >Astrazeneca</option>
                                        <option value="Johnson & Johnsons Janssen" <?php if($faculty['boosterBrand']=="Johnson & Johnsons Janssen") echo 'selected="selected"'; ?> >Johnson & Johnsons Janssen</option>
                                    </select>
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="boosterVaccinator" value="<?php echo $faculty['boosterVaccinator']?>">
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="boosterBatchNo" value="<?php echo $faculty['boosterBatchNo']?>">
                                </td>
                                <td>
                                    <input class="form-control" type="text" name="boosterLotNo" value="<?php echo $faculty['boosterLotNo']?>">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input name="facilityName" type="text" class="form-control" placeholder="Health Facility Name" value="<?php echo $faculty['facilityName']?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <input name="facilityContact" type="text" class="form-control" placeholder="Health Facility Contact No" value="<?php echo $faculty['facilityContact']?>">
                    </div>
                </div>
